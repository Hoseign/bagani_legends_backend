...
export const network_player_controller = (() => {
  ...
  class NetworkEntityController extends entity.Component {
    ...
    OnActionAttack_(msg) {
      this.net_.SendActionAttack_(msg);
    }

    OnUpdate_(msg) {
      // Removed transform snapping. 
      // The local player is controlled by BasicCharacterController.
      // Forcing the position here causes "rubber banding" because the 
      // server data is always slightly behind the local simulation.
